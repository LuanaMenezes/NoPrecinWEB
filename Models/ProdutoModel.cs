            ...
            using (var conexao = new SqlConnection())
            {
                ...
                using (var comando = new SqlCommand())
                {
                    ...
                    if (model == null)
                    {
                        comando.CommandText =
                            "insert into produto " +
                            "(nome, preco_venda, quant_estoque, ativo) values " +
                            "(@nome, @preco_venda, @quant_estoque, @ativo); select convert(int, scope_identity())";
                    ...
                    {
                        comando.CommandText =
                            "update produto set nome=@nome,preco_venda=@preco_venda, quant_estoque=@quant_estoque,  " +
